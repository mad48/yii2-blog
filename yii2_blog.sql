...
-- Дамп данных таблицы yii2_blog.migration: ~6 rows (приблизительно)
...
-- Дамп данных таблицы yii2_blog.tag: ~2 rows (приблизительно)
